...
-- Normally, when starting the EDA process we have some idea of what we're looking for
...
-- Earlier looking at companies with the most Layoffs. Now looking at that per year. It's a little more difficult.
-- Wanting to look at 
